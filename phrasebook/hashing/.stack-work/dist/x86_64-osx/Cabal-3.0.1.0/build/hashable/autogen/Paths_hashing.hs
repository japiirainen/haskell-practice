...
sysconfdir = "/Users/joona/dev/haskell-practice/phrasebook/hashing/.stack-work/install/x86_64-osx/4a5584e216a8149c4988547affc0ef4b1b282c54a4018d772b6347a78c4a8b75/8.8.4/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "hashing_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "hashing_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "hashing_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "hashing_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hashing_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hashing_sysconfdir") (\_ -> return sysconfdir)
