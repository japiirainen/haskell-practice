...
/* package project0-1.0.0 */
#ifndef VERSION_project0
#define VERSION_project0 "1.0.0"
#endif /* VERSION_project0 */
#ifndef MIN_VERSION_project0
#define MIN_VERSION_project0(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_project0 */
...
#define CURRENT_COMPONENT_ID "project0-1.0.0-inplace-project0"
